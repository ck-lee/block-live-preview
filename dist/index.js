...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _blockPreview = __webpack_require__(9);
	
	var _blockPreview2 = _interopRequireDefault(_blockPreview);
	...
	var scriptUrlsString = document.getElementById('preview').getAttribute('data-script-urls');
	var scriptUrls = scriptUrlsString.split(',');
	
	render(_react2.default.createElement(_blockPreview2.default, { scriptUrls: scriptUrls }), temp);
	
	setTimeout(function () {
		window.document.querySelector('.entry-content').replaceChild(temp.querySelector('#preview'), document.getElementById('preview'));
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactLoadScript = __webpack_require__(10);
	
	var _reactLoadScript2 = _interopRequireDefault(_reactLoadScript);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var _window$wp$blocks = window.wp.blocks,
	    serialize = _window$wp$blocks.serialize,
	    createBlock = _window$wp$blocks.createBlock,
	    getBlockTypes = _window$wp$blocks.getBlockTypes;
	var withSelect = window.wp.data.withSelect;
	
	
	function BlockPreview(props) {
		var scriptUrls = props.scriptUrls,
		    blocks = props.blocks;
		...
		scriptUrls.forEach(function (file) {
			if (file.match(/\.js$/ig)) {
				scripts.push(file);
		...
		var scriptLoaded = function scriptLoaded() {
			...
			var registeredBlocks = getBlockTypes();
			if (registeredBlocks.length) {
				var block = createBlock(registeredBlocks[registeredBlocks.length - 1].name);
		...
		return _react2.default.createElement(
			'div',
			{ id: 'preview' },
			scripts.map(function (scriptUrl, index) {
				return _react2.default.createElement(_reactLoadScript2.default, {
					key: index,
					url: scriptUrl,
					onLoad: scriptLoaded
				});
			}),
			css.map(function (cssUrl, index) {
			...
			_react2.default.createElement(
				...
				_react2.default.createElement('div', { className: 'playground__preview', dangerouslySetInnerHTML: previewHtml })
			)
		);
	}
